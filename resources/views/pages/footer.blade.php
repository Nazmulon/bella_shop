                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 clr">  
                        ...
                        <ul class="bfr-icn">   
                            ...
                            <li> <a href="#"> Epro is all about quality. </a> </li> 
                            <li> <a href="#"> Is your website user friendly ? </a> </li> 
                            <li> <a href="#"> Epro offer weekly updates & more. </a> </li> 
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-8">
                    <ul class="list-items payment-optn">
                        <li> <a href="#"> <img alt="" src="{{asset('frontend/assets/img/electronic/payment/img-1.png')}}"> </a> </li>
                        <li> <a href="#"> <img alt="" src="{{asset('frontend/assets/img/electronic/payment/img-2.png')}}"> </a> </li>
                        <li> <a href="#"> <img alt="" src="{{asset('frontend/assets/img/electronic/payment/img-7.png')}}"> </a> </li>
                        <li> <a href="#"> <img alt="" src="{{asset('frontend/assets/img/electronic/payment/img-3.png')}}"> </a> </li>
                        <li> <a href="#"> <img alt="" src="{{asset('frontend/assets/img/electronic/payment/img-8.png')}}"> </a> </li>
                        <li> <a href="#"> <img alt="" src="{{asset('frontend/assets/img/electronic/payment/img-4.png')}}"> </a> </li>
                        <li> <a href="#"> <img alt="" src="{{asset('frontend/assets/img/electronic/payment/img-5.png')}}"> </a> </li>
                        <li> <a href="#"> <img alt="" src="{{asset('frontend/assets/img/electronic/payment/img-6.png')}}"> </a> </li>
                    </ul>
                </div>
            </div>
        </div>
