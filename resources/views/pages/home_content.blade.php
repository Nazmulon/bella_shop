        ...
        <div class="row">  
            <div class="col-md-4 col-sm-4">
                <div class="banner" style="background-image: url({{asset('frontend/assets/img/electronic/banner/banner-1.jpg')}}); background-repeat: no-repeat; background-size: cover; background-position: center center;">
                    <div class="banner-content">
                        <h2 class="section-title white-color">Men Shart</h2>
            ...
            <div class="col-md-4 col-sm-4">
                <div class="banner" style="background-image: url({{asset('frontend/assets/img/electronic/banner/banner-2.jpg')}}); background-repeat: no-repeat; background-size: cover; background-position: center center;">
                    <div class="banner-content">
                        <h2 class="section-title white-color">Women Deshes</h2>
                        <p class="gray-color-2"> Lorem Ispum Dolor </p>
                        <p class="title-2"> <a href="#" class="white-arrow">  Shop Now <i class="arrow_right size-24"></i>    </a> </p>   
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-4">
                <div class="banner" style="background-image: url({{asset('frontend/assets/img/electronic/banner/banner-3.jpg')}}); background-repeat: no-repeat; background-size: cover; background-position: center center;">
                    <div class="banner-content">
                        <h2 class="section-title white-color">Child Deshes</h2>
                        <p class="gray-color-2"> Lorem Ispum Dolor </p>
                        <p class="title-2"> <a href="#" class="white-arrow">  Shop Now <i class="arrow_right size-24"></i>    </a> </p>   
                    </div>
                </div>
            ...
            <div  class="item">
                <div class="thumbnail-wrap">
                    <div class="thumbnail">
                            ...
                            <div class="flipper">
                                <div class="front">
                                    <a title="Product" href="#">
                                        <img class="img-responsive" src="{{asset($v_product->product_image)}}" alt="" style="height: 250px;" />                                                      
                                    </a>
                                </div>
                                <div class="back">                                                               
                                    <a href="#">
                        ...
                        <div class="caption">
                            <div class="caption-title space-15"><a href="#" class="title-2">{{$v_product->product_name}} </a></div> 
                            <div class="caption-text font-3"> <span class="size-18 black-color">TK.{{$v_product->product_price}}</span> <del class="gray-color"> TK.599.99 </del> </div>                                                   
                        </div>
                    ...
                    <div class="thumbnail">
                        <div class="thumbnail-img light-bg">
                            <div class="flipper">
                                ...
                                <div class="back">                                                               
                                    <a href="{{url('/view_product/'.$v_product->product_id)}}">
                                        <img class="img-responsive" src="{{asset($v_product->product_image)}}" alt="" style="height: 250px;"/>                                                      
                                    </a>
                                </div>   
                                <div class="sale-tag"> <span> sale </span> </div>
                        ...
                        <div class="caption">
                            <div class="caption-title space-15"><a href="#" class="title-2">{{$v_product->product_name}}</a></div> 
                            <div class="caption-text font-3"> <span class="size-18 black-color">TK.{{$v_product->product_price}} </span> <del class="gray-color">TK.150.95 </del> </div>                                                   
                        </div>
                    </div>
                </div>                       
                    ...
                    <div class="thumbnail">
                        <div class="thumbnail-img light-bg">
                            <div class="flipper">
                                ...
                                <div class="back">                                                               
                                    <a href="{{asset($v_product->product_image)}}">
                                        <img class="img-responsive" src="{{asset($v_product->product_image)}}" alt="" style="height: 250px;"/>                                                      
                                    </a>
                                </div>
                        ...
                        <div class="caption">
                            <div class="caption-title space-15"><a href="#" class="title-2">{{$v_product->product_name}}</a></div>
                            <div class="caption-text font-3"> <span class="size-18 black-color"> {{$v_product->product_price}}</span> </div>                                                     
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div  class="item">
                <div class="thumbnail-wrap">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <div class="caption-title space-15"><a href="#" class="title-2">{{$v_product->product_name}}</a></div> 
                            <div class="caption-text font-3"> <span class="size-18 black-color">TK>{{$v_product->product_price}}</span> <del class="gray-color">TK.399.51 </del> </div>                                                   
                        </div>
                    </div>
                </div>    
            </div>
    ...
    <div class="container theme-container">
        <div class="row">
            <div class="col-md-3 col-sm-5">
                <div class="arrv" style="background-image: url({{asset($v_product->product_image)}}); background-repeat: no-repeat; background-size: cover; background-position: center center;">
