			...
			<div class="card">
				<div class="card-header">
					<div class="card-title-wrap bar-danger">
						<h4 class="card-title" id="horz-layout-card-center">ADD CATEGORY</h4>
					</div>
				</div>
				<div class="card-body">
					<div class="px-3">
						<form class="form form-horizontal" action="{{url('/save_category')}}" method="post">
							{{csrf_field()}}
							<div class="form-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
										<textarea rows="2" class="form-control" name="category_description"></textarea>
									</div>
								</div>
